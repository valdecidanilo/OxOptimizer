    ...
    public class BuildLogsTab
    {
        ...
        public static void RenderGUI()
        {
            ...
            GUILayout.Label(OxLoc.T(
                ...
                "Clique em \"Analisar logs de build\" — o projeto precisa ter sido buildado ao menos uma vez nesta máquina."));
            ...
            GUILayout.Label(
                OxLoc.T(
                    ...
                    "Este utilitário analisa o Build Report do arquivo Editor.log. Ele mostra todos os arquivos incluídos no build final e a memória que ocupam. Use-o para encontrar mais oportunidades de reduzir o tamanho do build: texturas que ainda ocupam muita memória, sons sem compressão, ou coisas esquecidas em pastas Resources que entram no build."),
