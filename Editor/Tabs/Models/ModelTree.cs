...
namespace OxenteGames.OxOptimizer.Tabs
{
    class ModelTree : TreeViewWithTreeModel<ModelTreeItem>
    {
        ...
        void SortIfNeeded(TreeViewItem root, IList<TreeViewItem> rows)
        {
            ...
            var items = rootItem.children.Cast<TreeLib.TreeElementViewItem<ModelTreeItem>>().OrderBy(i => i.data.ModelName);
        ...
        {
            var item = (TreeLib.TreeElementViewItem<ModelTreeItem>)args.item;
        ...
        private void CellGUI(Rect cellRect, TreeLib.TreeElementViewItem<ModelTreeItem> item, int column, ref RowGUIArgs args)
        {
